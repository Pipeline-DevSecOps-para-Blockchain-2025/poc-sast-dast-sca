/**
 * From Solidity Security By Example: https://github.com/serial-coder/solidity-security-by-example
 * Source:
 * https://github.com/serial-coder/solidity-security-by-example/blob/main/06_integer_overflow/InsecureMoonToken.sol
 */
...
//  - On Medium:
// https://medium.com/valixconsulting/solidity-smart-contract-security-by-example-06-integer-overflow-e1f444f3cc4 - On
// serial-coder.com: https://www.serial-coder.com/post/solidity-smart-contract-security-by-example-06-integer-overflow/
...
contract InsecureMoonToken {
    ...
    function buy(uint256 _tokenToBuy) external payable {
        require(msg.value == _tokenToBuy * TOKEN_PRICE, "Ether received and Token amount to buy mismatch");
